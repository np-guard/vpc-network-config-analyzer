...
// GetCubesList returns the list of cubes in c, each cube as a slice of interval.CanonicalIntervalSet
...
// the input cube is a slice of interval.CanonicalIntervalSet, treated as ordered list of dimension values
