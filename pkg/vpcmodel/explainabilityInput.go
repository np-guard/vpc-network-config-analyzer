...
func getNodesFromAddress(c *VPCConfig, ipOrCidr string, inputIPBlock *ipblock.IPBlock) (nodes []Node,
	errType int, err error) {
	// 1.
...
func getCidrExternalNodes(c *VPCConfig, inputIPBlock *ipblock.IPBlock) (cidrNodes []Node, errType int, err error) {
	// 1.
