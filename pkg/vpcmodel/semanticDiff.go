...
func refineConfigExternalNodes(c *VPCConfig, disjointIPblocks []*netset.IPBlock) error {
	// copy config
	var err error
...
////       the idea is to use instead of *netset.TransportSet in the grouped entity a string which will encode the connection
