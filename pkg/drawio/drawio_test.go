...
func TestWithParsing(t *testing.T) {
	...
	createFileFromNetwork(n, "subnetGroupingBug.drawio", true, FileDRAWIO)
	n = createNetworkSubnetGroupingMultiVpc()
	createFileFromNetwork(n, "subnetGroupingMultiVpc.drawio", true, FileDRAWIO)
	...
	createFileFromNetwork(n, "subnetGroupingGroupInGroup.drawio", true, FileDRAWIO)
