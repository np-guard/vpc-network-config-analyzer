...
func (tn *NITreeNode) FIPStyle() string {
...
func (tn *NITreeNode) VsiStyle() string {
	return VsiStyle()
}

func (tn *VsiTreeNode) Style() string {
	return VsiStyle()
}
func (tn *NITreeNode) Style() string {
...
func (tn *UserTreeNode) Style() string {
...
func (tn *GatewayTreeNode) Style() string {
...
func (tn *InternetTreeNode) Style() string {
...
func (tn *InternetServiceTreeNode) Style() string {
...
func (tn *NetworkTreeNode) Style() string {
...
func (tn *VpcTreeNode) Style() string {
	return "rounded=0;whiteSpace=wrap;html=1;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;spacingBottom=-28;spacingTop=0;labelPosition=-100;verticalLabelPosition=top;align=center;verticalAlign=bottom;spacingLeft=9;spacing=0;expand=0;recursiveResize=0;spacingRight=0;container=1;collapsible=0;strokeColor=#1192E8;fillColor=none;"
}
func (tn *ZoneTreeNode) Style() string {
...
func (tn *SubnetTreeNode) Style() string {
	return "rounded=0;whiteSpace=wrap;html=1;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;spacingBottom=-28;spacingTop=0;labelPosition=-100;verticalLabelPosition=top;align=center;verticalAlign=bottom;spacingLeft=9;spacing=0;expand=0;recursiveResize=0;spacingRight=0;container=1;collapsible=0;strokeColor=#1192E8;fillColor=none;"
}
func (tn *PartialSGTreeNode) Style() string {
...
func (tn *VsiLineTreeNode) Style() string {
...
func (tn *NetworkTreeNode) TagStyle() string {
...
func (tn *VpcTreeNode) TagStyle() string {
...
func (tn *ZoneTreeNode) TagStyle() string {
...
func (tn *SubnetTreeNode) TagStyle() string {
...
func (tn *PartialSGTreeNode) TagStyle() string {
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////
func (tn *NetworkTreeNode) TextStyle() string {
...
func (tn *VpcTreeNode) TextStyle() string {
	return "text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;"
}
func (tn *ZoneTreeNode) TextStyle() string {
	return "text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;"
}
func (tn *SubnetTreeNode) TextStyle() string {
	return "text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;"
}
func (tn *PartialSGTreeNode) TextStyle() string {
	return "text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontFamily=IBM Plex Sans;fontSource=fonts%2FIBMPlexSans-Regular.woff;fontSize=14;"
}
func (tn *NITreeNode) TextStyle() string {
...
func (tn *ConnectivityTreeNode) TextStyle() string {
	return "edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];"
}

func (tn *VsiLineTreeNode) TextStyle() string {
	return "edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];"
}

// ////////////////////////////////////////////
func (tn *NetworkTreeNode) DecoreStyle() string {
	return "rounded=0;whiteSpace=wrap;html=1;strokeColor=none;fillColor=#1192E8;"
}
func (tn *VpcTreeNode) DecoreStyle() string {
	return "rounded=0;whiteSpace=wrap;html=1;strokeColor=none;fillColor=#1192E8;"
}
func (tn *ZoneTreeNode) DecoreStyle() string {
	return "rounded=0;whiteSpace=wrap;html=1;strokeColor=none;fillColor=#878d96;"
}
func (tn *SubnetTreeNode) DecoreStyle() string {
	return "rounded=0;whiteSpace=wrap;html=1;strokeColor=none;fillColor=#1192E8;"
}
func (tn *PartialSGTreeNode) DecoreStyle() string {
